...
<body class="preload" onload='setbutton("<?php echo $_SESSION["memberaccess"] ?>","<?php echo $_SESSION["myprofile"] ?>","<?php echo $_SESSION["manageraccess"] ?>","<?php echo $_SESSION["leaderaccess"] ?>","<?php echo $_SESSION["hraccess"] ?>","<?php echo $_SESSION["adminaccess"] ?>")'>
    ...
    <main>
        <div class="container">
			...
			<div class="item4">
				<table>
					<tr><td>EmpID</td><td>Annual Leave</td><td>15/12/2021 - 16/12/2021</td><td>Pending</td><td><a href="dptleavePendingview" ><button name="viewbtn" class="viewbtn" >View</button></a></td></tr>
				</table>
			</div>
        </div>        
    </main>
