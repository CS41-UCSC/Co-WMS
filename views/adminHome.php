...
<head>
	...
	<link rel="stylesheet" href="../Co-WMS/style/adminHome.css" type="text/css">
...
<body class="preload" onload='setbutton()'>
    ...
    <main>
        <div class="container">
		<div class="item1" >
			<form method="POST" action="adminHome/search">
			<center><input type="text" name="empId" value="EmployeeID" id="emp_search" />
		...
		<div class="item2">
			<center> 
				...
				<?php
					...
					foreach($emp as $row){
						echo '<tr id= ' . $row['0'] . '>';
						echo'<td class="row-data">'.$row['EmpID'].'</td>'.'<td class="row-data">'.$row['EmpName'].'</td>'.'<td class="row-data">'.$row['EmpRole'].'</td>'. '<td class="row-data"><a href="../Co-WMS/views/manageAccess.php" ><button type="button" class="pen"><i class="fa fa-pencil fa-lg"></i></a></button></td>';
						echo'</tr>';
					}
				?>
