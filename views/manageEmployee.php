...
<head>
    ...
    <link rel="stylesheet" href="../Co-WMS/style/manageEmployee_style.css">
            ...
            <div class="flex-container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-label="Profile">3</td>
                            <td data-label="Employee Id">Neha</td>
                            <td data-label="Employee Name">20</td>
                            <td data-label="Edit">90%</td>
                            <td data-label="Terminate">Passed</td>
                        </tr>

                        <tr>
                            <td data-label="Profile">4</td>
                            <td data-label="Employee Id">Priya</td>
                            <td data-label="Employee Name">30</td>
                            <td data-label="Edit">30%</td>
                            <td data-label="Terminate">Failed</td>
                        </tr>
                        <tr>
                            <td data-label="Profile">2</td>
                            <td data-label="Employee Id">Kamal</td>
