...
<head>
    ...
    <link rel="stylesheet" href="../Co-WMS/style/manageTeam_style.css?<?php echo time(); ?>">
                    ...
                    <?php
                            ...
                            foreach ($result as $row){
                                echo '<tr>';
                                    ...
                                    echo '<td data-label="Edit"><a href="manageTeamEditDelete"><i class="fa fa-pencil fa-lg" style="color:grey;" aria-hidden="true"></i></a></td>';
