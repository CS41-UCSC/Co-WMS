...
<head>
    ...
    <link rel="stylesheet" href="../Co-WMS/style/myprofile_style.css?<?php echo time(); ?>" type="text/css">
        ...
        <div class="container">
            ...
            <div class="item1"> 
                ...
                <div class="img-card">
                    ...
                    <img src="../Co-WMS/Asserts/<?php if($result[0]['Userimg']) {echo $result[0]['Userimg'];} else {echo 'avator.jpg';} ?>" alt="" id="photo">
