...
<head>
    ...
    <link rel="stylesheet" href="../Co-WMS/style/overdueTasks_style.css">
...
<body class="preload" onload='setbutton("<?php echo $_SESSION["memberaccess"] ?>","<?php echo $_SESSION["myprofile"] ?>","<?php echo $_SESSION["manageraccess"] ?>","<?php echo $_SESSION["leaderaccess"] ?>","<?php echo $_SESSION["hraccess"] ?>","<?php echo $_SESSION["adminaccess"] ?>")'>
    ...
    <nav class="nav">
        <div class="nav-links">
			...
			<a href="completedTasks" class="nav-link" id="my_progress">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td date-label="Done On">01.10.2021</td>
                            <td date-label="Reason">text</td>
                            <td date-label="Reason Status">text</td>
